...
fprintf(stdout, "CURLOPT_SSLCERTPASSWD = %d\n", CURLOPT_SSLCERTPASSWD);
fprintf(stdout, "CURLOPT_SSLKEYPASSWD = %d\n", CURLOPT_SSLKEYPASSWD);
...
fprintf(stdout, "CURLOPT_FTPLISTONLY = %d\n", CURLOPT_FTPLISTONLY);
fprintf(stdout, "CURLOPT_FTPAPPEND = %d\n", CURLOPT_FTPAPPEND);
...
fprintf(stdout, "CURLOPT_KRB4LEVEL = %d\n", CURLOPT_KRB4LEVEL);
